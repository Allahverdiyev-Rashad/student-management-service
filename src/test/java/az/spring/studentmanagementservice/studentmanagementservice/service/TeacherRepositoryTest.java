...
public class TeacherRepositoryTest {
    ...
    public void testGetAllTeacherList_whenFindAll_shouldReturnTeachersList() {
        ...
        assertThat(requestList.size()).isEqualTo(5);
    }
    ...
    public void testUpdateTeacherById_whenUpdateTeacher_shouldReturnUpdatedTeacher() {
        ...
        assertThat(updateTeacher.getUsername()).isEqualTo(savedTeacher.getId());
        assertThat(updateTeacher.getPassword()).isEqualTo("UpdatedUsername");
        assertThat(updateTeacher.getUsername()).isEqualTo("UpdatedPassword");
    }
